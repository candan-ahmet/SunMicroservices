...
namespace SunFramework.Aspect.Utils
{
    ...
    {
        private const string ProxyNameSpace = "SunFramework.Aspect.DynamicGenerated";
        private const string ProxyAssemblyName = "SunFramework.Aspect.DynamicProxy.Generator";
