...
namespace SunFramework.Aspect.Configuration
{
    public static class NonAspectsCollectionExtensions
    {
        ...
        {
            collection.AddNamespace("SunFramework.Aspect.Configuration");
            collection.AddNamespace("SunFramework.Aspect.DynamicProxy");
            collection.AddNamespace("SunFramework.Aspect.Injector");
            collection.AddNamespace("SunFramework.Aspect.Configuration.*");
            collection.AddNamespace("SunFramework.Aspect.DynamicProxy.*");
            collection.AddNamespace("SunFramework.Aspect.Injector.*");
            collection.AddNamespace("SunFramework.Aspect.Extensions.*");
            return collection;
        }
